...
This website is composed of Rmarkdown documents, which could be used as templates for generating exploratory plots. The Rmarkdown documents can be accessed on [Gitlab](https://gitlabce.statwb.eu.novartis.net/KHANSFA1/xGx/tree/master/Rmarkdown).
...
The graphs on this website were created with [Good Graphics Principles](https://github.com/GraphicsPrinciples/CheatSheet/blob/master/NVSCheatSheet.pdf) in mind. For additional plotting resources in R and SAS, see the [Graph Gallery](https://graphics.statwb.eu.novartis.net/).
