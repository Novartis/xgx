...
Many of the codes on this website use functions that we have found to be helpful while exploring PK/PD data. We compiled these helpful functions into the xgxr R-package, which is available on [CRAN](https://cran.r-project.org/web/packages/xgxr/index.html), and [GitHub](https://github.com/Novartis/xgxr).
...
The graphs on this website were created with [Good Graphics Principles](https://github.com/GraphicsPrinciples/CheatSheet/blob/master/NVSCheatSheet.pdf) in mind. Also check out the [Presentation Checklist](https://opensource.nibr.com/xgx/Resources/Presentation_Checklist_v2.03.pdf) for useful tips on creating presentations of your results.
