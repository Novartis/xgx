...
NCA <- pd_data[pd_data$PROFDAY%in%c(1,6),] %>%
                       select(ID,PROFDAY,Response = LIDV,TRTACT_low2high) %>%
...
data_to_plot <- list()
data_to_plot[[1]] <- pk_data[pk_data$TRTACT_low2high!="Placebo",c("TIME","LIDV","ID","TRTACT_low2high")]
data_to_plot[[1]]$Concentration <- data_to_plot[[1]]$LIDV
data_to_plot[[1]]$LIDV <- NULL

data_to_plot[[2]] <- pd_data[pd_data$CMT==3,c("TIME","LIDV","ID","TRTACT_low2high")]
data_to_plot[[2]]$Response <- data_to_plot[[2]]$LIDV
data_to_plot[[2]]$LIDV <- NULL
