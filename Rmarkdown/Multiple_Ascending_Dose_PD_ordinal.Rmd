...
```{r, error = TRUE, cache = TRUE, fig.width = 8, fig.height = 8, warning = FALSE, message = FALSE}
...
gg2 <- gg2 + xgx_annotate_status(status)
gg2 <- gg2 + xgx_stat_ci(distribution = "ordinal", position = position_dodge(width = 50), alpha = 0.5) 
gg2 <- gg2 + scale_y_continuous(labels = scales::percent)
