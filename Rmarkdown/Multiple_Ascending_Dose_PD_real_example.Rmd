---
title: "PD - Multiple Ascending Dose - Real Data"
output:
  html_document:
    toc: true
    toc_float: true
...
## Overview
This document contains PD exploratory graphs and also the R code that generates these graphs. The plots presented here are based on a real Novartis project which involved multiple types of PD data, from continuous endpoints to ordinal response and count data.  It was developed by Kostas Biliouris and Alison Margolskee.
...
Data specifications can be accessed on [Datasets](http://exploratory-graphics-xgx.statwb-dev.eu.novartis.net/Datasets.html) and Rmarkdown template to generate this page can be found on [Rmarkdown-Template](http://exploratory-graphics-xgx.statwb-dev.eu.novartis.net/Rmarkdown/Multiple_Ascending_Dose_PD_real_example.Rmd).
