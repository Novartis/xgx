...
#file.remove("../*.html")
#file.copy(file.path("www",files_html),file.path("..",files_html),recursive = TRUE)
...
#unlink("../*_files")
#file.copy(file.path("www",folders_files),file.path("..",folders_files),recursive = TRUE)
