...
gg <- ggplot(data= my.data,aes(x=factor(Dose), y=AUCAVE, fill=factor(AE))) 
...
```{r, cache = TRUE, fig.width = 8, fig.height = 4, warning = FALSE, message= FALSE}
gg <- ggplot(data = my.data, aes(y=AUCAVE,x=AE))
...
```{r, cache = TRUE, fig.width = 8, fig.height = 4, warning = FALSE, message= FALSE} 
gg1 <- ggplot(data = my.data, aes(x=Dose,y=AE_binary))
...
gg2 <- gg1 + xgx_scale_x_log10(breaks=unique(my.data$Dose)) 
...
```{r, cache = TRUE, fig.width = 8, fig.height = 4, warning = FALSE, message= FALSE}
gg <- ggplot(data = my.data, aes(x=AUCAVE,y=AE_binary))
